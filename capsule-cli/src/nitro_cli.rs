...
that capsule-cli output images contain EIF files, which are potentially very
large. If you have been doing a lot of capsule-cli builds, consider cleaning up
