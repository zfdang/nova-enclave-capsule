...
use capsule_cli::manifest::HostFsMountConfig;
use capsule_cli::runtime_vsock::RuntimeHostVsockPorts;
use capsule_cli::vsock::VMADDR_CID_HOST;
use fuse_mt::{
...
fn entry_type_to_file_type(entry_type: capsule_cli::fs_protocol::FsEntryType) -> FileType {
    match entry_type {
        capsule_cli::fs_protocol::FsEntryType::File => FileType::RegularFile,
        capsule_cli::fs_protocol::FsEntryType::Directory => FileType::Directory,
        capsule_cli::fs_protocol::FsEntryType::Symlink => FileType::Symlink,
        capsule_cli::fs_protocol::FsEntryType::Other => FileType::RegularFile,
    }
}

fn metadata_to_attr(metadata: &capsule_cli::fs_protocol::FsMetadata) -> FileAttr {
